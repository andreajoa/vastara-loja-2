  ...
  return (
    <div style={{fontFamily:"'Inter',-apple-system,sans-serif",minHeight:'100vh',background:'#0a0a0a'}}>
      <style suppressHydrationWarning>{`
        ...
        .hero-video-bg{display:block;position:absolute;right:0;top:0;height:100%;width:60%;object-fit:cover;opacity:0.75}.hero-img-mobile{display:none!important}@media(max-width:900px){.hero-video-bg{display:none!important}.hero-img-mobile{display:block!important}@media(max-width:900px){
          .col-sb{display:none}
      ...
      <div style={{background:'#0a0a0a',padding:'96px 0 0',position:'relative',overflow:'hidden',borderBottom:'0.5px solid rgba(255,255,255,0.06)',minHeight:'560px'}}>
        ...
        <div style={{position:'relative',padding:'0 48px 64px 32px',maxWidth:'480px',zIndex:2}}>
