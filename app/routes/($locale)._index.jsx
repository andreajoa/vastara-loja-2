    ...
    <div className="hp">
      <style suppressHydrationWarning>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .hp-brand-card-img-wrapper{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;padding:20px}
        .hp-brand-card-img-wrapper img{width:100%;height:100%;object-fit:contain;opacity:0.9;transition:transform 0.7s ease,opacity 0.4s ease}
        .hp-brand-card:hover .hp-brand-card-img-wrapper img{transform:scale(1.06);opacity:1}
        .hp-brand-card-overlay{position:absolute;inset:0;background:linear-gradient(to top,rgba(0,0,0,0.98) 0%,rgba(0,0,0,0.7) 35%,rgba(0,0,0,0.2) 65%,rgba(0,0,0,0.05) 100%);pointer-events:none}
        ...
        .hp-brand-card-feat img{position:absolute;inset:0;width:100%;height:100%;object-fit:contain;object-position:center;padding:20px;opacity:0.85;transition:transform 0.7s,opacity 0.4s}
